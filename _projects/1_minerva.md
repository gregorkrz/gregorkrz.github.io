...
{% include figure.liquid loading="eager" path=page.img class="img-fluid rounded z-depth-1" max-width="60%" caption=page.image_caption %}
...
Explore a sample of MINERvA events used in the study in the [interactive event viewer](https://d1to0n5578l1po.cloudfront.net/event_viewer.html). See the [paper](https://arxiv.org/abs/2604.12364) for more info.
